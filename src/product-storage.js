...
const products = [
  {
    ...
    price: {
      usd: { amount: 4.99, currency: '$' },
      hryvnia: { amount: 31.2, currency: '₴' }
    },
  ...
  },
  {
    ...
    price: {
      usd: { amount: 9.99, currency: '$' },
      hryvnia: { amount: 45.0, currency: '₴' }
    },
    nutrition: noSugar,
    allergy: null,
    category: "Hot 'n Spicy",
  ...
  },
  {
    ...
    price: {
      usd: { amount: 7.99, currency: '$' },
      hryvnia: { amount: 41.8, currency: '₴' }
    },
    nutrition: lowFat,
  ...
  },
  {
    ...
    price: {
      usd: { amount: 4.2, currency: '$' },
      hryvnia: { amount: 29.5, currency: '₴' }
    },
    nutrition: lowFat,
    allergy: [fish],
    category: "Hot 'n Spicy",
  ...
  },
  {
    ...
    price: {
      usd: { amount: 2.99, currency: '$' },
      hryvnia: { amount: 27.0, currency: '₴' }
    },
    nutrition: highProtein,
    allergy: null,
    category: "Hot 'n Spicy",
  ...
  },
  {
    ...
    price: {
      usd: { amount: 5.99, currency: '$' },
      hryvnia: { amount: 35.0, currency: '₴' }
    },
    nutrition: highProtein,
  ...
  },
  {
    ...
    price: {
      usd: { amount: 6.9, currency: '$' },
      hryvnia: { amount: 38.0, currency: '₴' }
    },
    nutrition: highProtein,
    allergy: [nuts],
    category: 'Cool as Ice',
  ...
  },
  {
    ...
    price: {
      usd: { amount: 8.37, currency: '$' },
      hryvnia: { amount: 43.0, currency: '₴' }
    },
    nutrition: lowFat,
    allergy: [wheat],
    category: 'Cool as Ice',
