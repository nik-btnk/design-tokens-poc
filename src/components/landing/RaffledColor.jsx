...
export const RaffledColor = ({
  ...
  return (
    <>
        ...
        <article className="raffled-color__card">
          ...
          <div className="raffled-color__info">
            <p className="raffled-color__description">
              ...
              id deleniti harum porro nemo doloremque dolore unde placeat ullam
              nisi soluta quisquam ipsa qui! Nostrum minima soluta optio fugit
              sunt inventore, rem vitae excepturi temporibus consectetur vel
              molestias tempora magnam esse, expedita iure beatae sit eius error
      ...
      <div className="raffled-color__block"></div>
    </>
  )
}
