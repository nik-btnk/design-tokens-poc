...
const StyleDictionary = require('style-dictionary').extend('./style_dictionary/config.json')
...
StyleDictionary.registerTransformGroup({
    name: 'less',
    transforms: StyleDictionary.transformGroup["less"].concat(transforms.map( val => val.name))
})
